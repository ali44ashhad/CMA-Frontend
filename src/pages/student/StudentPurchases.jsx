              ...
              <div className="p-5">
                ...
                <div className="flex items-center gap-3 mt-5 flex-wrap">
                  ...
                  <button
                    ...
                    className="flex-1 min-w-[140px] px-4 py-2.5 bg-gradient-to-r from-[#137952] to-[#0d5c3d] text-white text-sm font-medium rounded-xl hover:from-[#0d5c3d] hover:to-[#0a4a2e] transition-all shadow-sm flex items-center justify-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {mapPaymentToUiStatus(purchase.paymentStatus) === "active" && (
                    <button
                      ...
                      className="flex-1 min-w-[140px] px-4 py-2.5 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center"
