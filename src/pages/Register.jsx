    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.03]">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="register-page-grid" width="40" height="40" patternUnits="userSpaceOnUse">
              <path d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" strokeWidth="1" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#register-page-grid)" />
        </svg>
      </div>
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 lg:p-10">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#137952]/10 to-[#137952]/5 border border-[#137952]/30 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-[#137952]">Join CMA Test Series</span>
          </div>
          ...
          <p className="text-gray-600 text-sm mb-6">
            Start your CMA preparation with free Foundation tests and expert evaluation.
          </p>
          ...
          <p className="mt-6 text-sm text-center text-gray-600">
            ...
            <Link to="/login" className="font-medium text-[#137952] hover:text-[#0d5c3d] transition">
              Sign in
            </Link>
          </p>
        </div>
